...
router.post('/:id/likes', isAuth, PostsControllers.addLike());
router.delete('/:id/likes', isAuth, PostsControllers.delLike());
router.patch('/:id/likes', isAuth, PostsControllers.toggleLike());
